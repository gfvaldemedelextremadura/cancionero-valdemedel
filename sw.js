const C='valdemedel-v4-17';
const PDF_CACHE='valdemedel-dance-pdfs-v417';
const A=['./','./index.html','./styles.css?v=4.17','./supabase-config.js?v=4.17','./supabase-lite.js?v=4.17','./app.js?v=4.17','./manifest.webmanifest','./logo-burdeos.png','./logo-blanco.png','./logo-texto.png','./actuacion-infantil.jpeg','./romeria.jpeg','./musicos-historicos.jpeg','./grupo.jpeg','./musicos-escenario.jpeg','./festival.jpeg','./tamborilero.jpeg','./baile.jpeg'];
