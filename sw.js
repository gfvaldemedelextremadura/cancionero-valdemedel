const C='valdemedel-v4.49';
const PDF_CACHE='valdemedel-v4.49-pdfs';
...
self.addEventListener('fetch',e=>{const r=e.request;if(r.method!=='GET')return;const u=new URL(r.url);
 ...
 if(r.mode==='navigate'){e.respondWith(timedFetch(r,5000).then(resp=>{const copy=resp.clone();caches.open(C).then(c=>c.put('./index.html',copy));return resp}).catch(()=>caches.match('./index.html')));return;}
