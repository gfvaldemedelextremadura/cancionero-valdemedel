const C='valdemedel-v4-14';
const A=['./','./index.html','./styles.css?v=4.14','./supabase-config.js?v=4.14','./supabase-lite.js?v=4.14','./app.js?v=4.14','./logo-burdeos.png','./logo-blanco.png','./logo-texto.png','./actuacion-infantil.jpeg','./romeria.jpeg','./musicos-historicos.jpeg','./grupo.jpeg','./musicos-escenario.jpeg','./festival.jpeg','./tamborilero.jpeg','./baile.jpeg'];
